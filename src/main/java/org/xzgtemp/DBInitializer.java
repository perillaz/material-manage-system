...
//TODO：增加触发器
	...
	public void init() {
		...
		jdbcTemplate.update("CREATE TABLE IF NOT EXISTS User(id VARCHAR(13) PRIMARY KEY,name VARCHAR(30) NOT NULL,password VARCHAR(30) NOT NULL,usertype VARCHAR (10) NOT NULL,setAdmini BOOLEAN NOT NULL,setStudent BOOLEAN NOT NULL)");
