...
public class DBInitializer {
	...
	public void init() {
		...
		jdbcTemplate.update("CREATE TABLE IF NOT EXISTS Book(id BIGINT PRIMARY KEY NOT NULL AUTO_INCREMENT,title VARCHAR(50) NOT NULL,author VARCHAR(50) NOT NULL,copyamount INTEGER NOT NULL DEFAULT 0,borrowcopys INTEGER NOT NULL DEFAULT 0,allborrowtimes INTEGER NOT NULL DEFAULT 0,isbn VARCHAR(13),edition VARCHAR(30),publishtime Date,publisher VARCHAR(30),briefinfo VARCHAR(1000))");
